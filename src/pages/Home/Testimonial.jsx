...
export default function Testimonial() {
  return (
    <>
      <div>
        <h2 className="px-4 pt-16 text-xl font-semibold leading-6 text-center ">
          Testimonials
        </h2>
        <h1 className="px-4 mt-6 text-2xl font-bold leading-10 text-center lg:text-5xl md:text-4xl">
          What our client says
        </h1>
        <div className="container grid gap-5 px-10 py-20 mx-auto sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:px-20">
          <div>
            <div className="relative flex flex-col items-center w-full p-6 bg-white shadow-md cursor-pointer group hover:bg-green-50 md:p-12">
              <div className="flex flex-col items-center text-gray-600 group-hover:text-white">
                ...
                <p className="px-3 mt-4 text-base leading-normal text-center text-gray-500 xl:w-80">
              ...
              <div className="absolute bottom-0 -mb-6 text-white group-hover:text-green-50">
                <svg
                  width={34}
                  height={28}
                  viewBox="0 0 34 28"
