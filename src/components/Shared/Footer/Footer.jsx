...
const Footer = () => {
  return (
    <div className="">
      <footer className="px-4 text-black divide-y bg-[#c5f2d1] ">
        <div className="flex flex-col justify-between py-10 mx-auto space-y-8 max-w-7xl lg:flex-row lg:space-y-0">
        ...
        <div className="py-6 text-sm text-center dark:text-gray-400">
          © Pollinate Company Co. All rights reserved.
        </div>
      </footer>
    </div>
  );
