    ...
    <>
      ...
      >
        <div>
          ...
          <div className='flex flex-col justify-between flex-1 mt-6'>
            ...
            <nav>
              {/* host menu items */}
              {
               loggedUserData?.role == 'surveyor' && <SurveyorMenu></SurveyorMenu>
              }
        ...
        <div>
          ...
          <button onClick={logOut} className='flex items-center w-full px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform hover:bg-gray-300 hover:text-gray-700'>
